---
title: Drupal 8-9 Performance and Varnish Caching Settings
description: Optimize Drupal 8-9 and Varnish caching to maximize your Pantheon site's performance.
cms: "Drupal"
...
## Caching Modules and Settings



## Page-Level Caching

For page-level caching, a number of modules and strategies are available. Selecting the combination that best suits the needs of your site will take some planning and optimization.

### Pantheon Advanced Page Cache Module

The Pantheon Advanced Page Cache module `pantheon_advanced_page_cache`() is available for Drupal 7, 8, and 9. 

[what it does, instructions on setup and use]

### Internal Page Cache Core Modules

The Drupal core Internal Page Cache and Internal Dynamic Page Cache modules cache pages (including those with dynamic content) for anonymous users, and can be used when external page caching is not available.

### How to Turn Off Anonymous Page Caching

![caching settings](../images/drupal-8-performance-settings.png)

In Drupal 8 and 9, anonymous page caching is enabled by default. There is no option to turn it on or off. To disable caching for development purposes, set the "Page cache maximum age" to **no caching**.
...
- [Drupal 8-9 Dynamic Page Cache](https://www.drupal.org/docs/8/core/modules/dynamic-page-cache)
